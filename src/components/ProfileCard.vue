    ...
    <div class="flex-1">
      ...
      <div class="flex flex-col sm:flex-row gap-3">
        <a
          :href="cvUrl"
          download
          class="bg-orange-500 hover:bg-orange-600 text-white px-5 py-3 rounded-xl font-medium flex items-center justify-center gap-2 transition w-full sm:w-auto"
        >
