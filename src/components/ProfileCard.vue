...
<template>
  <div class="col-start-2 col-end-4 row-start-1 bg-white rounded-2xl shadow-sm p-8 flex gap-8">
    ...
    <div class="flex-1">
      ...
      <div class="flex gap-3">
        <button class="bg-orange-500 hover:bg-orange-600 text-white px-5 py-3 rounded-xl font-medium flex items-center gap-2 transition">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3"/>
          </svg>
          Download CV
        </button>
        <button class="border border-gray-200 hover:bg-gray-50 text-gray-700 px-5 py-3 rounded-xl font-medium flex items-center gap-2 transition">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <!-- Kanan: Info Pribadi -->
    <div class="w-80 border border-gray-100 rounded-2xl p-6 flex-shrink-0">
