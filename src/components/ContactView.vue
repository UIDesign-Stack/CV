...
<template>
  ...
  <div class="md:col-start-2 md:col-end-4 md:row-start-2 bg-zinc-900/0 rounded-2xl shadow-sm p-8">
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <div>
        <h2 class="font-bold text-zinc-50 text-xl">Contact</h2>
        <p class="text-sm text-zinc-400">Silakan hubungi saya melalui informasi di bawah ini.</p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="space-y-4">
        <div
          ...
          :key="item.label"
          class="flex items-center gap-4 border border-zinc-800 rounded-2xl p-4"
        >
      ...
      <!-- Kanan: Form kontak -->
      <form @submit.prevent="submitForm" class="border border-zinc-800 rounded-2xl p-5 space-y-4">
        <div>
          ...
          <input
            ...
            class="w-full border border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-orange-400"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <textarea
            ...
            class="w-full border border-zinc-700 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-orange-400 resize-none"
          ></textarea>
        </div>
        <button
          type="submit"
