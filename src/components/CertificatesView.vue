...
const certificates = [
  {
    title: 'Seminar Nasional Komputasi Masa Depan',
    subtitle: 'Windows 10, Hyper-V dan Azure',
    date: '02 April 2016',
  },
  {
    title: 'Menjadi Programmer Web',
    subtitle: 'Sebagai Pengisi Materi',
    date: '03 Desember 2016 - 07 Januari 2017',
  },
  {
